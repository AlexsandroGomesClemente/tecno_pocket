...
server.use(routers_default);
server.use(import_express2.default.static("public"));
server.post("/uploadImage", upload.single("imagem"), (req, res) => __async(exports, null, function* () {
  try {
...
server.listen(process.env.PORT, () => {
  console.log("Servidor rotando na porta:", process.env.PORT, "\u{1F60E}");
});
